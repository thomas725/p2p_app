...
def get_file_purpose(filepath: str) -> str:
    ...
    purposes = {
        ...
        'connected.rs': 'Connected peers tracking & monitoring',
        'group_crypto.rs': 'Group topic encryption & key derivation',
        'groups.rs': 'Group management & persistence',
        ...
        'key_probe.rs': 'Keyboard enhancement probe',
