...
def main():
    ...
    print("| Metric                      | Value   |")
    print("|:--------------------------|--------:|")
    print(f"| Total Rust Files            | {total_files:>4} |")
    print(f"| Total Lines of Code        | {total_lines:>5,} |")
    print(f"| Total Characters           | {total_chars:>5,} |")
    print(f"| Average Lines per File     | {avg_lines:>4} |")
    print(f"| Average Characters/File    | {avg_chars:>5,} |")
    print()
