...
|:----------------------|:----------------|
| Total Rust Files      |              43 |
| Total Rust Lines      |          12,443 |
| Total Rust Chars      |         451,541 |
| Avg Lines/Rust File   |             289 |
| Avg Chars/Rust File   |          10,500 |
| Total Dart Files      |               9 |
| Total Dart Lines      |           5,143 |
| Total Dart Chars      |         156,400 |
| Avg Lines/Dart File   |             571 |
| Avg Chars/Dart File   |          17,377 |
| Covered Dart Lines    | 41 / 1,839 (2%) |
...
**Grand Total:** 54 files, 17,790 lines, 614,746 characters
...
| src                     | behavior.rs          |     6 |  6685 |   188 |        - |       - | Network behavior definitions           |
...
| src                     | frb_generated.rs     |     6 | 72919 |  1814 |        - |       - | flutter_rust_bridge codegen            |
| src                     | lib.rs               |     1 |  6084 |   162 |        - |       - | Module declarations & re-exports       |
| src                     | logging.rs           |     4 | 11659 |   359 |        - |       - | Logging utilities & setup              |
| src                     | messages.rs          |     4 |  9473 |   281 |        - |       - | Message persistence & retrieval        |
| src                     | mobile_api.rs        |     4 | 14623 |   414 |        - |       - | Mobile FRB API surface                 |
...
| src                     | tui_helpers.rs       |     5 | 14767 |   460 |        - |       - | TUI helper functions & utilities       |
| src                     | tui_render.rs        |     5 | 20454 |   580 |        - |       - | TUI rendering & state management       |
| src                     | tui_render_state.rs  |     4 | 14288 |   425 |        - |       - | TUI render state & tab content         |
...
| src/bin/tui             | main_loop.rs         |     4 | 13266 |   353 |        - |       - | Task orchestration & async             |
| src/bin/tui             | message_handlers.rs  |     5 |  4269 |   133 |        - |       - | Message sending logic                  |
| src/bin/tui             | scroll_handlers.rs   |     5 | 10336 |   288 |        - |       - | Scroll & hover-aware navigation        |
| src/bin/tui             | state.rs             |     4 | 10537 |   267 |        - |       - | Shared application state               |
| src/bin/tui/render_loop | layout.rs            |     3 |  2881 |    85 |        - |       - | UI layout component rendering          |
| src/bin/tui/render_loop | mod.rs               |     6 |  7962 |   235 |        - |       - | Render loop orchestration (60 FPS)     |
| src/generated           | columns.rs           |     1 |  1974 |    49 |        - |       - | Auto-generated column definitions      |
...
| src/generated           | schema.rs            |     2 |  2116 |    88 |        - |       - | Database schema (Diesel)               |

**Total:** 43 files, 12,443 lines, 451,541 characters
...
| unit   | unit_bin_tui_click_handlers.rs     |   438 | 15794 |     3 | Unit tests for TUI click handlers     |
...
| unit   | unit_tui_helpers.rs                |   414 | 14361 |     3 | Unit tests for TUI helpers            |
...
**Total:** 51 test files, 15,232 lines, 482,863 characters

## Dart Source Files

| Folder       | File                   | Depth | Chars | Lines | Testable | Covered | Purpose                             |
|:-------------|:-----------------------|------:|------:|------:|---------:|--------:|------------------------------------:|
| lib          | main.dart              |    19 | 63062 |  2021 |      939 |   3.94% | Flutter app entry point             |
| lib/src/rust | api.dart               |     2 |  5526 |   154 |       34 |   5.88% | FRB API bindings (generated)        |
| lib/src/rust | frb_generated.dart     |     6 | 56692 |  1833 |      724 |   0.28% | flutter_rust_bridge codegen         |
| lib/src/rust | frb_generated.io.dart  |     3 |  8673 |   348 |        5 |   0.00% | FRB IO bindings (generated)         |
| lib/src/rust | frb_generated.web.dart |     2 |  8593 |   348 |        - |       - | FRB web bindings (generated)        |
| lib/src/rust | messages.dart          |     5 |  1254 |    38 |        9 |   0.00% | Dart source file                    |
| lib/src/rust | mobile_api.dart        |     5 |  6849 |   208 |       65 |   0.00% | Mobile API bindings (generated)     |
| lib/src/rust | mobile_node.dart       |     5 |  4668 |   156 |       63 |   0.00% | Mobile node bindings (generated)    |
| lib/src/rust | types.dart             |     5 |  1083 |    37 |        - |       - | Shared type definitions (generated) |

**Total:** 9 files, 5,143 lines, 156,400 characters (41/1839 testable lines covered, 2%)
