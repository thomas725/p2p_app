...
|:----------------------|:--------------------|
| Total Rust Files      |                  39 |
| Total Rust Lines      |              11,606 |
| Total Rust Chars      |             418,497 |
| Avg Lines/Rust File   |                 297 |
| Avg Chars/Rust File   |              10,730 |
| Covered Rust Lines    | 2,373 / 3,811 (62%) |
| Total Dart Files      |                   8 |
| Total Dart Lines      |               5,150 |
| Total Dart Chars      |             156,043 |
| Avg Lines/Dart File   |                 643 |
| Avg Chars/Dart File   |              19,505 |
| Covered Dart Lines    |    117 / 1,855 (6%) |
...
**Grand Total:** 49 files, 16,957 lines, 581,241 characters
...
| src                     | tui_render.rs        |     5 | 21498 |   600 |      295 |  82.71% | TUI rendering & state management    |
| src                     | tui_render_state.rs  |     4 | 14776 |   433 |      140 |  95.71% | TUI render state & tab content      |
| src                     | tui_tabs.rs          |     5 |  8341 |   249 |       87 |  95.40% | Tab management & navigation         |
...
| src/bin/tui             | click_handlers.rs    |     6 | 11749 |   290 |      158 |  93.67% | Click handlers & index mapping      |
...
| src/bin/tui             | input_processor.rs   |     5 | 20211 |   541 |      240 |  78.33% | Input event routing & processing    |
...
| src/bin/tui             | scroll_handlers.rs   |     5 | 10928 |   302 |      133 |  96.24% | Scroll & hover-aware navigation     |
| src/bin/tui             | state.rs             |     5 | 11235 |   277 |       63 |  95.24% | Shared application state            |
| src/bin/tui/render_loop | layout.rs            |     3 |  1586 |    48 |       31 |  22.58% | UI layout component rendering       |
| src/bin/tui/render_loop | mod.rs               |     6 |  8096 |   237 |       88 |  50.00% | Render loop orchestration (60 FPS)  |
...
**Total:** 39 files, 11,606 lines, 418,497 characters (2373/3811 testable lines covered, 62%)
...
| tests  | tui_render_integration.rs         |   873 | 28230 |     5 | TUI render integration tests          |
...
| unit   | unit_bin_tui_input_processor.rs   |   992 | 33977 |     4 | Unit tests for TUI input processor    |
...
| unit   | unit_bin_tui_scroll_handlers.rs   |   600 | 19224 |     3 | Unit tests for TUI scroll handlers    |
...
**Total:** 50 test files, 15,355 lines, 488,232 characters

## Dart Source Files

| Folder       | File                   | Depth | Chars | Lines | Testable | Covered | Purpose                          |
|:-------------|:-----------------------|------:|------:|------:|---------:|--------:|---------------------------------:|
| lib          | main.dart              |    18 | 66207 |  2152 |      978 |  11.35% | Flutter app entry point          |
...
**Total:** 8 files, 5,150 lines, 156,043 characters (117/1855 testable lines covered, 6%)
...
| widget  | peer_list_test.dart            |   212 |  7298 |     5 | Dart test file                        |
| test    | widget_test.dart               |    19 |   615 |     2 | Widget smoke tests                    |

**Total:** 4 test files, 343 lines, 11,769 characters
