...
| src                     | db.rs                |     6 | 15198 |   421 |         - |       - | Database connection & identity mgmt |
| src                     | dioxus_app.rs        |    11 | 19052 |   537 |         - |       - | Web UI app shell & components (Dio… |
...
| src                     | lib.rs               |     1 |  5586 |   147 |         - |       - | Module declarations & re-exports    |
...
| src                     | nickname.rs          |     5 |  3445 |    98 |         - |       - | Nickname management                 |
...
| src                     | tui_render_state.rs  |     4 | 11457 |   372 |         - |       - | TUI render state & tab content      |
| src                     | tui_tabs.rs          |     5 |  4793 |   168 |         - |       - | Tab management & navigation         |
| src                     | types.rs             |     2 |  3279 |   110 |         - |       - | Event & command type defs           |
| src/bin                 | p2p_chat.rs          |     7 |  4936 |   134 |         - |       - | CLI chat application                |
| src/bin                 | p2p_chat_dioxus.rs   |     8 |  8206 |   215 |         - |       - | Web UI (Dioxus framework)           |
...
**Total:** 37 files, 6,817 lines, 234,827 characters
...
| unit   | unit_bin_tui_command_processor.rs |   764 | 23960 |     4 | Unit tests for TUI command processor  |
...
| unit   | unit_bin_tui_message_handlers.rs  |   229 |  7093 |     4 | Unit tests for TUI message handlers   |
...
**Total:** 50 test files, 13,371 lines, 409,756 characters
